...
data = pickle.load(open('D:/AIT-2023/NLP/A5/app/model/data.pkl', 'rb'))
...
class BERT_Tokenizer:
    def __init__(self, word2id):
        ...
        self.id2word    = {i:w for i, w in enumerate(word2id)}
    ...
    def tokenize(self, sentences):
        ...
        for sentence in sentences:
            ...
            for word in sentence.lower().split():
                input_ids.append(self.word2id.get(word, word2id['[UNK]']))
            ...
            # mask position
            candidates_masked_pos = [i for i, token in enumerate(input_ids) if token != [0]]

            output['input_ids'].append(torch.tensor(input_ids))
            output['attention_mask'].append(torch.tensor(candidates_masked_pos))
